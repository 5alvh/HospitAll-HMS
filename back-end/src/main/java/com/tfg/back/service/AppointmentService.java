...
public interface AppointmentService {
     ...
     */
    AppointmentDtoGet bookAppointment(UUID doctorId, LocalDate date, LocalTime startTime, String email, AppointmentType type, String reason, AppointmentStatus status);
     ...
     */
    Long getTotalPatientsThatVisitedDoctor(UUID id);
